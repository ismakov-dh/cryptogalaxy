...
Possible values : ftx, coinbase-pro, binance, bitfinex, hbtc, huobi, gateio, kucoin, bitstamp, bybit, probit, gemini.
...
4. Executes the app for 5 minute to get the data from exchanges.
