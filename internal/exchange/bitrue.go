...
func (b *bitrue) wsTickersToTerminal(ctx context.Context) error {
	for {
		select {
...
func (b *bitrue) wsTradesToTerminal(ctx context.Context) error {
	for {
		select {
...
func (b *bitrue) wsTickersToMySQL(ctx context.Context) error {
	for {
		select {
...
func (b *bitrue) wsTradesToMySQL(ctx context.Context) error {
	for {
		select {
...
func (b *bitrue) wsTickersToES(ctx context.Context) error {
	for {
		select {
...
func (b *bitrue) wsTradesToES(ctx context.Context) error {
	for {
		select {
...
func (b *bitrue) wsTickersToInflux(ctx context.Context) error {
	for {
		select {
...
func (b *bitrue) wsTradesToInflux(ctx context.Context) error {
	for {
		select {
...
func (b *bitrue) wsTickersToNats(ctx context.Context) error {
	for {
		select {
...
func (b *bitrue) wsTradesToNats(ctx context.Context) error {
	for {
		select {
...
func (b *bitrue) wsTickersToClickHouse(ctx context.Context) error {
	for {
		select {
...
func (b *bitrue) wsTradesToClickHouse(ctx context.Context) error {
	for {
		select {
...
func (b *bitrue) wsTickersToS3(ctx context.Context) error {
	for {
		select {
...
func (b *bitrue) wsTradesToS3(ctx context.Context) error {
	for {
		select {
