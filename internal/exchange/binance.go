...
func (b *binance) wsTickersToInflux(ctx context.Context) error {
	for {
		select {
...
func (b *binance) wsTradesToInflux(ctx context.Context) error {
	for {
		select {
...
func (b *binance) wsTickersToNats(ctx context.Context) error {
	for {
		select {
...
func (b *binance) wsTradesToNats(ctx context.Context) error {
	for {
		select {
...
func (b *binance) wsTickersToClickHouse(ctx context.Context) error {
	for {
		select {
...
func (b *binance) wsTradesToClickHouse(ctx context.Context) error {
	for {
		select {
...
func (b *binance) wsTickersToS3(ctx context.Context) error {
	for {
		select {
...
func (b *binance) wsTradesToS3(ctx context.Context) error {
	for {
		select {
